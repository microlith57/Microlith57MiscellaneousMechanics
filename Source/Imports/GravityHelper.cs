...
namespace Celeste.Mod.Microlith57Misc.Imports {
    ...
    public static partial class GravityHelper {
        ...
        // public static partial void SetPlayerGravity(int gravityType, float momentumMultiplier);
        public static partial void SetActorGravity(Actor actor, int gravityType, float momentumMultiplier);
